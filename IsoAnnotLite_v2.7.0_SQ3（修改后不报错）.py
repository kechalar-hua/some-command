...
def mappingFeatures(dc_SQexons, dc_SQcoding, dc_SQtransGene, dc_SQgeneTrans, dc_SQstrand, dc_GFF3exonsTrans, dc_GFF3transExons, dc_GFF3, dc_GFF3gene, dc_GFF3coding, dc_GFF3geneTrans, dc_geneID2geneName, dc_geneName2geneID, dc_GFF3transGene, filename, filename_prints):
    ...
    for transSQ in dc_SQexons.keys():
        ...
        else: #new.txt Transcript and we have to run possible matches for all transcripts of the gene
    ...
    #new.txt dictionary to remove duplicates
    realAnnotLines = {}
    annotInterest = ""
...
#UPDATE GFF3 - new.txt columns information
...
def run(args):
    ...
    if USE_GFF3:
        ...
        t2 = time.time()
        time = t2-t1
        print("Time used to generate new.txt GFF3: " + "%.2f" % time + " seconds.\n")
