...
def write_count(seq_id, seq, seq_len):
    ...
    data1.to_csv(writer, index=False)
    data2.to_csv(writer, index=False)
    data3.to_csv(writer, index=False)
...
if __name__ == "__main__":
    ...
    file_path = abs_path + '\\' + 'Final_trans_oneline.fasta'  # 获取当前目录下的文件信息
